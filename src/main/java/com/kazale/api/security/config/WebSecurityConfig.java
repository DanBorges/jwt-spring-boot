...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configureAuthentication(AuthenticationManagerBuilder authenticationManagerBuilder) throws Exception {
		authenticationManagerBuilder.userDetailsService(this.userDatailsService).passwordEncoder(passwordEncoder());
	}
	...
	//necesseita autorização para todas as URLs, exceto as que estiver abaixo de /auth
	@Override
